...
var app = {
	...
	URL_PLUGIN: 'https://github.com/andreszs/cordova-plugin-recaptcha-v2',
	URL_DEMO: 'https://www.andreszsogon.com/cordova-plugin-recaptcha-v2-demo/',
	...
	verify: function () {
		var onSuccess = function (strToken) {
			$('#token').html(strToken);
			$('#status').html('<span class="success">You have 2 minutes to validate this token as shown in reCAPTCHA &gt; Server Side Validation &gt; Verify the User\'s Response.</span>');
		};
		...
		var args = {};
		args.siteKeyAndroid = $('#siteKeyAndroid').val();
		args.siteKeyWeb = $('#siteKeyWeb').val();
